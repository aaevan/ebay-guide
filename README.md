...
* Ask, am I willing to wait up to a month and a half for it to get here?
  ...
  * If you're not willing to wait that long, under **Item Location**, make sure to check the box that says, North America. 
    * generally, ordering something from somewhere from the continental US will a week or two max to get to you.
...
If you're buying something kinda obscure, you might only get 2 or 3 active listings, but that's what the "Save this search" button is for.

If it's substantially cheaper than surrounding listings (especially for buy it now listings), there's a decent chance that the seller is pulling some kind of scam. I've only had this happen to me maybe twice in my hundreds of ebay purchases.
